    ...
    <div class="pl-2 xs:pr-5 md:pr-16">
      ...
      <div class="pl-5 pt-5 mt-10">
        <div class="hallOfFame_tab flex flex-row mb-2">
          <a href="" class="text-xl text-gray-900 mr-10 active_tab"
            >Program details</a
          >
          <a href="" class="text-xl text-gray-900 mx-10"
            >Announcement <span class="pink">12</span></a
          >
      ...
      <div class="grid grid-cols-3 discovery_norecent">
        <div class="col-span-2 mt-8 px-6">
          ...
          <div
            class="mb-6 flex bg-white border border-solid border-blue-500 rounded"
          >
            ...
            <span class="p-4 flex items-center text-gray-400 text-xs"
              >This program only awards points for VRT based submissions.</span
            >
          </div>
              ...
              <tbody>
                <tr>
                  <td class="text-gray-700 text-xs">
                    Any subdomain of bigbank. * not explicitly listed as "In
                    Scope"
                  </td>
                  <td class="text-gray-700 text-xs">
                    any Github asset under https://github.com/bigbank-as
                  </td>
                </tr>
                <tr>
                  <td class="text-gray-700 text-xs">
                    Any sites which resolve to 185.235.160.18
                  </td>
          ...
          <p class="text-base my-20 text-gray-700">
            ...
            maxime sed! Tempora minus id fuga! Non cumque porro, atque, illo
            ipsum officia sapiente ut voluptas commodi libero ullam? Deleniti
            recusandae earum debitis fugit voluptatem, officiis eius architecto,
          ...
          >
            ...
            support@teklabspace.com before going any further.
          </p>
