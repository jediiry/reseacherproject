  ...
  <div>
    ...
    <div class="p-4">
      <!-- <div class="hallOfFame_tab flex flex-row mb-10">
                <a href="" class="font-title text-gray-400 mr-10 lg:ml-10">Program details</a>
                <a href="" class="font-title text-gray-400 mr-10">Announcement</a>
                <a href="" class="font-title text-gray-400 active_tab">Hall of fame</a>
            </div> -->
      <tab></tab>

      <div>
        <h1 class="mb-2 text-2xl">Hall of Fame</h1>
        <span class="text-sm mb-7 text-gray-500"
          >Thanks to the following researchers for reporting important security
          issues:</span
        >
          ...
          <tbody>
            <tr>
              ...
              <td class="flex items-center">
                <img
                  class="avatar rounded-full inline mr-3"
